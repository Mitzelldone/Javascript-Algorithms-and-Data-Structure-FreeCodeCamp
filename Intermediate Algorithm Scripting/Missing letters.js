...
function fearNotLetter(str) {
    for (var i=0; i < str.length; i++) {
        ...
        // if code of current character is not equal to first character + number of iteration hence character has been escaped.
...
- It is checked if code of current character is the expected one (no characters are skipped) by using the logic -
